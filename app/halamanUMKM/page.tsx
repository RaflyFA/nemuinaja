  ...
  return (
    <PageLayout containerClassName={styles.container} mainClassName={""}>
      ...
      <div className={styles.sellerCard}>
        ...
        {/* PERBAIKAN LOGIKA LINK: Mengarahkan ke halaman profil UMKM statis, sesuai kode duplikat Anda */}
      ...
      {otherProduct ? (
        // PERBAIKAN LOGIKA LINK: Menggunakan query param ?id= sesuai setup `useSearchParams`
      ...
      {/* PERBAIKAN UTAMA:
        Blok duplikat yang masif telah dihapus dari sini.
        Error Vercel Anda yang asli ada di bawah ini.
      */}

      <div style={{ textAlign: 'center', marginTop: 8 }}>Bagikan pengalaman Anda</div>
      <div className={styles.stars}>
        {/* PERBAIKAN DARI ERROR VERCEL ASLI:
          Loop .map() sekarang dibuka komentarnya.
          <div className={styles.detailTitle}>...</div> telah DIHAPUS dari dalam loop.
        */}
        {[1, 2, 3, 4, 5].map((n) => (
      ...
      {/* ERROR 's' acak telah dihapus dari sini.
        Semua kode duplikat telah dihapus.
      */}
    ...
    // <-- Tag </> penutup yang tidak perlu telah dihapus.
  )
}