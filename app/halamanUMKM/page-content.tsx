...
export default function HalamanUMKMPageContent() {
  ...
  return (
    <PageLayout containerClassName={styles.container} mainClassName={""}>
      ...
      <div className={styles.desc}>
        <p>{umkm?.description ?? "Deskripsi produk tidak tersedia."}</p>
      </div>
      ...
      <div className={styles.sellerCard}>
        ...
        <Link href={`/halamanUMKM/${id}`}><button className={styles.visitBtn}>Kunjungi</button></Link>
      </div>
